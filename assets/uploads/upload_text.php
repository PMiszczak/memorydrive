...
$target_dir = '../../drive/' . $_SESSION['class'] . '/' . $_SESSION['login'] . '/pliki_tekstowe' . '/';
...
// Walidacja - czy plik nie jest większy niż 5MB?
if ($_FILES["file_to_upload"]["size"] > 5000000) {
    $uploadOk = 0;
}

// Walidacja - czy plik posiada rozszerzenie txt, docx, doc, pdf, pages?
if ($file_type != "txt" && $file_type != "docx" && $file_type != "doc" && $file_type != "pdf" && $file_type != "pages") {
    $uploadOk = 0;
}
