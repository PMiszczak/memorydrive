...
$target_dir = '../../drive/' . $_SESSION['class'] . '/' . $_SESSION['login'] . '/kod' . '/';
...
// Walidacja - czy plik posiada rozszerzenie cpp, css, html, php lub js?
if ($file_type != "cpp" && $file_type != "css" && $file_type != "html" && $file_type != "php" && $file_type != "js") {
    $uploadOk = 0;
}
